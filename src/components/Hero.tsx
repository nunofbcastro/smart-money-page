...
const Hero = () => {
  ...
  return (
    <section className="pt-20 pb-16 bg-gradient-to-b from-background to-muted/50">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="px-8 py-3 text-lg font-semibold border-2 hover:bg-accent transition-colors"
            >
